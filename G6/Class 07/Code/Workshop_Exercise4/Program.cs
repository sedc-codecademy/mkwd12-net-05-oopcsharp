using Workshop_Exercise4.Models;
...
Driver d1 = new Driver("Martin", 3);     //constructor1
Driver d2 = new Driver(5, "Antonio");    //constructor2
...
do
{
    ...
    {
        if (firstCarChoice >= 1 && firstCarChoice <= 4 && secondCarChoice >= 1 && secondCarChoice <= 4
            && firstDriverChoice >= 1 && firstDriverChoice <= 4 && secondDriverChoice >= 1 && secondDriverChoice <= 4)
        {
            ...
            // firstSelectedCar.Model = "Opel";

            firstSelectedCar.Driver = firstSelectedDriver;  //on an already created object we are adding/changing values of a prop
        ...
        {
            Console.WriteLine("Wrong input! Please enter a number from 1-4!");
        }
    }
    else
    {
...
//student1 = new Student {"Tijana", "Stojanovska"}
